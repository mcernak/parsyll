...
int main(int argc,char *argv[]){
	...
	double *chan, *chch, *Ichannel2D, *IIchannel2D, *I_prefilt, *II_prefilt, II_prefilt_zero, *Dconv, *Dconv_zero;
	...
	int nthr, *cumspk, TTrect, n_overthr, *T_overthr, *cumspk_over, lmax, imax, imax2, *T_synS, nsynS;
...
*/
    ...
    for (t=0; t<TT; t++) {
		...
		for (i=0; i<n; i++) {
            ...
            *VV += dt*( IL + Idc[i] + *IIt*Iext[i] + Isyn + knoise[i]*random_normal()) / C_val;                
